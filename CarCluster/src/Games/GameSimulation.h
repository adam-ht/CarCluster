...
struct ClusterConfiguration {
  float speedCorrectionFactor = 1.090909090909091;   // Calibration of speed gauge
  float rpmCorrectionFactor = 1.00;     // Calibration of RPM gauge
  int maximumRPMValue = 8000;           // Set what is the maximum RPM on your cluster
  int maximumSpeedValue = 260;          // Set what is the maximum speed on your cluster (in km/h)
  int minimumCoolantTemperature = 50;    // Set what is the minimum coolant temperature on your cluster (in C)
  int maximumCoolantTemperature = 130;  // Set what is the maximum coolant temperature on your cluster (in C)
...
class GameState {
  ...
  int oilTemperature = 90;                           // Oil temperature (from 50 to 190)
